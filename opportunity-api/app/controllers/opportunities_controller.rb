class OpportunitiesController < ApplicationController
  ...
  def lowest_ask
    ...
    if lowest_kraken[0] < lowest_btce[0]
      Ask.new(exchange: 'kraken', value: lowest_kraken[0])
    else
  ...
  def largest_bid
    ...
    if higher_kraken[0] > higher_btce[0]
      Bid.new(exchange: 'kraken', value: higher_kraken[0])
    else
